...
def main():
    ...
    read_cmd = subparsers.add_parser('show', help='Show schema or records of the PFB file')
    ...
    dict2pfb_cmd = subparsers.add_parser('dict2pfb', help='Convert datadictionary into PFB file with schema')
